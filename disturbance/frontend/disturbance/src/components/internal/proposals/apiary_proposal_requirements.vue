    ...
    methods:{
        ...
        editRequirement(_id){
            ...
            .then(async (response) => {
                ...
                this.$refs.requirement_detail.requirement.referral_group=data.referral_group;
                this.$refs.requirement_detail.requirement.requirement_documents=data.requirement_documents;
